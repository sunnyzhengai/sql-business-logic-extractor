...
Cohesion: 0.04
Nodes (101): avg(), count(), max_agg(), min_agg(), Aggregate function patterns: COUNT, SUM, AVG, MIN, MAX., sum_agg(), Context, Pattern (+93 more)
...
Cohesion: 0.05
Nodes (48): _add_meta(), _dedupe_resolved_filters(), _format_text(), _get_output_filename(), LineageResolver, main(), _normalize_meta_key(), _parse_header_comments() (+40 more)
...
Cohesion: 0.11
Nodes (39): batch_process(), BatchResult, _classify_error(), _progress(), Process all SQL files matching pattern under path.      Args:         path: Dire, Write combined Collibra import files., Write a summary report., Write a human-readable action items report for failures that need review. (+31 more)
