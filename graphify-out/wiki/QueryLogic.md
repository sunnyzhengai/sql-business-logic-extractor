...
> God node · 27 connections · `sql_logic_extractor/extract.py`
...
- [[Classify an output column into a business logic category.     Returns (category,]] `INFERRED`
- [[Classify a filter into a category.]] `INFERRED`
- [[Converts Layer 1 extraction output into normalized business definitions.]] `INFERRED`
- [[Convert Layer 1 output dict into a list of BusinessDefinitions.]] `INFERRED`
- [[Create a BusinessDefinition from an output column.]] `INFERRED`
- [[Create a BusinessDefinition from a filter.]] `INFERRED`
