...
COL_COLS = [
    ...
    "CM_LOG_OWNER_ID", "IS_PRESERVED_YN", "COLUMN_NOTES", "DEPRECATED_YN",
    "REAL_TM_ENABLED_YN", "RECORD_STATUS_C", "TRANSLATED_YN",
    "TRANS_EXTENSION_ID", "REPL_CHAR_YN", "REPLACEMENT_COLUMNS",
    "VALID_DIS_EPIC_YN", "VALID_DIS_EPIC_RSN", "VALID_DIS_CUST_YN",
    "VALID_DIS_CUST_RSN", "LAST_MODIFIED_BY_EPIC_DTTM",
