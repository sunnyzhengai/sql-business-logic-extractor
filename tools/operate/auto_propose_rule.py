...
Notebook usage:
    ...
    from tools.operate.auto_propose_rule import propose_rules
    propose_rules(input_dir='/lakehouse/default/Files/views')

CLI:

    python -m tools.operate.auto_propose_rule <input_dir>
...
from tools.operate.auto_propose_rule_hypotheses import HYPOTHESES, Hypothesis
...
4. Run: `python -m tools.operate.preflight_check <views_dir>` and confirm
